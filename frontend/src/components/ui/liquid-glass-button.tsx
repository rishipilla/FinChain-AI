...
function LiquidButton({
  ...
  return (
    <Comp
      data-slot="button"
      className={cn("relative isolate overflow-hidden rounded-xl border border-white/20 bg-white/10 text-white shadow-[0_10px_30px_rgba(96,165,250,0.24)] backdrop-blur-xl transition-all duration-300 hover:scale-[1.02] hover:bg-white/15 hover:shadow-[0_18px_40px_rgba(96,165,250,0.34)] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60", liquidbuttonVariants({ variant, size, className }))}
      {...props}
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.35),transparent_52%)]" />
      <div className="absolute inset-[1px] rounded-[11px] bg-gradient-to-br from-white/15 via-white/5 to-transparent" />
